    ...
    <div className="mx-auto w-full max-w-3xl px-6 py-16">
      ...
      <Section title="Third-party code">
        <p>
          ...
          No advertising, no tracking pixels, no social buttons, no donation
          widget, no fonts fetched from anybody else&apos;s servers. Every line
          of code that runs while you use this site is served from this site,
          apart from the page-level analytics described above. Nothing else is
          in a position to see that you were here, let alone what you entered.
        </p>
        <p>
          That is enforced by a test rather than by memory. The suite fails the
          build if a script from another host appears anywhere in the site&apos;s
          own code, and if a frame is ever added, it fails unless that frame is
          sandboxed and denied access to this origin.
        </p>
      </Section>
