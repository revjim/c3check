 ...
 * One generation.
 *
 * A card rather than a row in a table. Twelve columns is unreadable at 375px,
 * maintaining two markups so one of them can be a table is a cost with no
 * return, and a card takes `break-inside: avoid` so a printed report never
 * splits a generation across a page break.
 */
    ...
    <li className="break-inside-avoid rounded-lg border border-border p-5">
      <div className="flex flex-wrap items-baseline justify-between gap-x-4 gap-y-1">
        ...
        <p className="text-sm text-subtle">
          {index === 0 ? "Earliest generation entered" : null}
        </p>
      </div>
